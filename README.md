...
2. **Enter OpenAI API Key:**
    ...
    - ⚠️ Note: You will use your OpenAI credits to generate the summaries/flashcards. Make sure to have some credits in your account or the extension will not work.
